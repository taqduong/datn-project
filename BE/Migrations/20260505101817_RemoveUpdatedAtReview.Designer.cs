...
namespace BE.Migrations
{
    ...
    [Migration("20260505101817_RemoveUpdatedAtReview")]
    partial class RemoveUpdatedAtReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BE.Models.Cart", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId", "ProductId", "VariantId" }, "IX_Carts_User_Product_Variant_Unique")
                        .IsUnique()
            ...
            modelBuilder.Entity("BE.Models.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BE.Models.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BE.Models.ProductAnalytics", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId" }, "IX_ProductAnalytics_ProductId_Unique")
                        .IsUnique();
            ...
            modelBuilder.Entity("BE.Models.UserActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BE.Models.Voucher", b =>
                {
                    ...
                    b.Property<string>("ResetInterval")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BE.Models.Wishlist", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId", "ProductId" }, "IX_Wishlist_User_Product_Unique")
                        .IsUnique();
