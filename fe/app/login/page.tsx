...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Đợi 1.5 giây rồi chuyển trang
      setTimeout(() => {
        // Trigger re-render navbar bằng cách dispatch event
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <p className="text-green-600 font-medium">Đăng nhập thành công! Đang chuyển hướng...</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            >
              {success ? '✓ Thành công' : isLoading ? 'Đang xử lý...' : 'Đăng nhập'}
            </button>
          </form>
